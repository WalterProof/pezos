...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class WorkersPrevalidatorsChainIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Shell\Model\WorkersPrevalidatorsChainIdGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Shell\Model\WorkersPrevalidatorsChainIdGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('pending_requests', $data)) {
                ...
                foreach ($data['pending_requests'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Pezos\Generated\Shell\Model\WorkersPrevalidatorsChainIdGetResponse200PendingRequestsItem::class, 'json', $context);
                }
                $object->setPendingRequests($values);
                unset($data['pending_requests']);
            }
            if (\array_key_exists('current_request', $data)) {
                $object->setCurrentRequest($this->denormalizer->denormalize($data['current_request'], \Pezos\Generated\Shell\Model\WorkersPrevalidatorsChainIdGetResponse200CurrentRequest::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Shell\Model\WorkersPrevalidatorsChainIdGetResponse200::class => false];
        }
    }
} else {
    class WorkersPrevalidatorsChainIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
