...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NetworkPeersPeerIdGetResponse200PeerMetadataUnadvertisedNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Shell\Model\NetworkPeersPeerIdGetResponse200PeerMetadataUnadvertised::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Shell\Model\NetworkPeersPeerIdGetResponse200PeerMetadataUnadvertised::class;
        }
        ...
        {
            return [\Pezos\Generated\Shell\Model\NetworkPeersPeerIdGetResponse200PeerMetadataUnadvertised::class => false];
        }
    }
} else {
    class NetworkPeersPeerIdGetResponse200PeerMetadataUnadvertisedNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
