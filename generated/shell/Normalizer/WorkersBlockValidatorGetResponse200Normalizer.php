...
class WorkersBlockValidatorGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Pezos\\Generated\\Shell\\Model\\WorkersBlockValidatorGetResponse200';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Pezos\\Generated\\Shell\\Model\\WorkersBlockValidatorGetResponse200';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Pezos\Generated\Shell\Model\WorkersBlockValidatorGetResponse200();
        ...
        if (\array_key_exists('pending_requests', $data)) {
            ...
            foreach ($data['pending_requests'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Pezos\\Generated\\Shell\\Model\\WorkersBlockValidatorGetResponse200PendingRequestsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('backlog', $data)) {
            ...
            foreach ($data['backlog'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Pezos\\Generated\\Shell\\Model\\WorkersBlockValidatorGetResponse200BacklogItem', 'json', $context);
            }
            $object->setBacklog($values_1);
        }
        if (\array_key_exists('current_request', $data)) {
            $object->setCurrentRequest($this->denormalizer->denormalize($data['current_request'], 'Pezos\\Generated\\Shell\\Model\\WorkersBlockValidatorGetResponse200CurrentRequest', 'json', $context));
        }
        return $object;
    }
