...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NetworkPeersPeerIdPatchResponse200PeerMetadataPrevalidatorResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadataPrevalidatorResults::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadataPrevalidatorResults::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadataPrevalidatorResults();
        ...
        {
            return [\Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadataPrevalidatorResults::class => false];
        }
    }
} else {
    class NetworkPeersPeerIdPatchResponse200PeerMetadataPrevalidatorResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
