...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NetworkPeersPeerIdPatchResponse200PeerMetadataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadata::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadata::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('requests', $data)) {
                $object->setRequests($this->denormalizer->denormalize($data['requests'], \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadataRequests::class, 'json', $context));
                unset($data['requests']);
            }
            ...
            if (\array_key_exists('prevalidator_results', $data)) {
                $object->setPrevalidatorResults($this->denormalizer->denormalize($data['prevalidator_results'], \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadataPrevalidatorResults::class, 'json', $context));
            ...
            if (\array_key_exists('unadvertised', $data)) {
                $object->setUnadvertised($this->denormalizer->denormalize($data['unadvertised'], \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadataUnadvertised::class, 'json', $context));
                unset($data['unadvertised']);
            }
            if (\array_key_exists('advertisements', $data)) {
                $object->setAdvertisements($this->denormalizer->denormalize($data['advertisements'], \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadataAdvertisements::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200PeerMetadata::class => false];
        }
    }
} else {
    class NetworkPeersPeerIdPatchResponse200PeerMetadataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
