...
class PatchNetworkPeerByPeerId extends \Pezos\Generated\Shell\Runtime\Client\BaseEndpoint implements \Pezos\Generated\Shell\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $peerId, ?\Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchBody $requestBody = null)
    {
        $this->peer_id = $peerId;
    ...
    {
        if ($this->body instanceof \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchBody) {
    ...
    /**
     * @return \Pezos\Generated\Shell\Model\NetworkPeersPeerIdPatchResponse200|null
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Pezos\\Generated\\Shell\\Model\\NetworkPeersPeerIdPatchResponse200', 'json');
        }
