...
class GetMinimalValidTime extends \Bzzhh\Pezos\Generated\Proto\Runtime\Client\BaseEndpoint implements \Bzzhh\Pezos\Generated\Proto\Runtime\Client\Endpoint
{
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['priority', 'endorsing_power']);
        $optionsResolver->setRequired(['priority', 'endorsing_power']);
        $optionsResolver->setDefaults([]);
        $optionsResolver->setAllowedTypes('priority', ['string']);
        $optionsResolver->setAllowedTypes('endorsing_power', ['string']);
