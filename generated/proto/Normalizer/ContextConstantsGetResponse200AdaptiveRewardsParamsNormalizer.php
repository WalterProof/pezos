...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ContextConstantsGetResponse200AdaptiveRewardsParamsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParams::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParams::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('issuance_ratio_final_max', $data)) {
                $object->setIssuanceRatioFinalMax($this->denormalizer->denormalize($data['issuance_ratio_final_max'], \Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParamsIssuanceRatioFinalMax::class, 'json', $context));
                unset($data['issuance_ratio_final_max']);
            }
            if (\array_key_exists('issuance_ratio_initial_min', $data)) {
                $object->setIssuanceRatioInitialMin($this->denormalizer->denormalize($data['issuance_ratio_initial_min'], \Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParamsIssuanceRatioInitialMin::class, 'json', $context));
                unset($data['issuance_ratio_initial_min']);
            }
            if (\array_key_exists('issuance_ratio_initial_max', $data)) {
                $object->setIssuanceRatioInitialMax($this->denormalizer->denormalize($data['issuance_ratio_initial_max'], \Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParamsIssuanceRatioInitialMax::class, 'json', $context));
            ...
            if (\array_key_exists('growth_rate', $data)) {
                $object->setGrowthRate($this->denormalizer->denormalize($data['growth_rate'], \Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParamsGrowthRate::class, 'json', $context));
                unset($data['growth_rate']);
            }
            if (\array_key_exists('center_dz', $data)) {
                $object->setCenterDz($this->denormalizer->denormalize($data['center_dz'], \Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParamsCenterDz::class, 'json', $context));
                unset($data['center_dz']);
            }
            if (\array_key_exists('radius_dz', $data)) {
                $object->setRadiusDz($this->denormalizer->denormalize($data['radius_dz'], \Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParamsRadiusDz::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Proto\Model\ContextConstantsGetResponse200AdaptiveRewardsParams::class => false];
        }
    }
} else {
    class ContextConstantsGetResponse200AdaptiveRewardsParamsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
