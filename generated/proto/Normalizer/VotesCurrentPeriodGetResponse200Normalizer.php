...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class VotesCurrentPeriodGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Proto\Model\VotesCurrentPeriodGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Proto\Model\VotesCurrentPeriodGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('voting_period', $data)) {
                $object->setVotingPeriod($this->denormalizer->denormalize($data['voting_period'], \Pezos\Generated\Proto\Model\VotesCurrentPeriodGetResponse200VotingPeriod::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Proto\Model\VotesCurrentPeriodGetResponse200::class => false];
        }
    }
} else {
    class VotesCurrentPeriodGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
