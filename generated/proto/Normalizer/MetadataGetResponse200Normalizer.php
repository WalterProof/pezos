...
class MetadataGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\MetadataGetResponse200';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\MetadataGetResponse200';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Bzzhh\Pezos\Generated\Proto\Model\MetadataGetResponse200();
        ...
        if (\array_key_exists('max_operation_list_length', $data)) {
            ...
            foreach ($data['max_operation_list_length'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\MetadataGetResponse200MaxOperationListLengthItem', 'json', $context);
            }
