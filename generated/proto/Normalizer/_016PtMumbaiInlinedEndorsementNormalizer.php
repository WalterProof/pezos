...
class _016PtMumbaiInlinedEndorsementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\_016PtMumbaiInlinedEndorsement';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\_016PtMumbaiInlinedEndorsement';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Bzzhh\Pezos\Generated\Proto\Model\_016PtMumbaiInlinedEndorsement();
        ...
        if (\array_key_exists('operations', $data)) {
            $object->setOperations($this->denormalizer->denormalize($data['operations'], 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\_016PtMumbaiInlinedEndorsementMempoolContents', 'json', $context));
