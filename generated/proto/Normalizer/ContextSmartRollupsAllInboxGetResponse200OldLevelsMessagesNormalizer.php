...
class ContextSmartRollupsAllInboxGetResponse200OldLevelsMessagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\ContextSmartRollupsAllInboxGetResponse200OldLevelsMessages';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\ContextSmartRollupsAllInboxGetResponse200OldLevelsMessages';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Bzzhh\Pezos\Generated\Proto\Model\ContextSmartRollupsAllInboxGetResponse200OldLevelsMessages();
        ...
        if (\array_key_exists('content', $data)) {
            $object->setContent($this->denormalizer->denormalize($data['content'], 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\ContextSmartRollupsAllInboxGetResponse200OldLevelsMessagesContent', 'json', $context));
            unset($data['content']);
        }
