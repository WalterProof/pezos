...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ContextContractsContractIdEntrypointsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Proto\Model\ContextContractsContractIdEntrypointsGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Proto\Model\ContextContractsContractIdEntrypointsGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('unreachable', $data)) {
                ...
                foreach ($data['unreachable'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Pezos\Generated\Proto\Model\ContextContractsContractIdEntrypointsGetResponse200UnreachableItem::class, 'json', $context);
                }
                $object->setUnreachable($values);
                unset($data['unreachable']);
            }
            if (\array_key_exists('entrypoints', $data)) {
                $object->setEntrypoints($this->denormalizer->denormalize($data['entrypoints'], \Pezos\Generated\Proto\Model\ContextContractsContractIdEntrypointsGetResponse200Entrypoints::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Proto\Model\ContextContractsContractIdEntrypointsGetResponse200::class => false];
        }
    }
} else {
    class ContextContractsContractIdEntrypointsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
