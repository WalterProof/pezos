...
class HelpersScriptsSimulateOperationPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\HelpersScriptsSimulateOperationPostBody';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\HelpersScriptsSimulateOperationPostBody';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Bzzhh\Pezos\Generated\Proto\Model\HelpersScriptsSimulateOperationPostBody();
        ...
        if (\array_key_exists('operation', $data)) {
            $object->setOperation($this->denormalizer->denormalize($data['operation'], 'Bzzhh\\Pezos\\Generated\\Proto\\Model\\HelpersScriptsSimulateOperationPostBodyOperation', 'json', $context));
