...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class HelpersScriptsRunCodePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Proto\Model\HelpersScriptsRunCodePostBody::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Proto\Model\HelpersScriptsRunCodePostBody::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('other_contracts', $data)) {
                ...
                foreach ($data['other_contracts'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Pezos\Generated\Proto\Model\HelpersScriptsRunCodePostBodyOtherContractsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('extra_big_maps', $data)) {
                ...
                foreach ($data['extra_big_maps'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \Pezos\Generated\Proto\Model\HelpersScriptsRunCodePostBodyExtraBigMapsItem::class, 'json', $context);
                }
        ...
        {
            return [\Pezos\Generated\Proto\Model\HelpersScriptsRunCodePostBody::class => false];
        }
    }
} else {
    class HelpersScriptsRunCodePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
