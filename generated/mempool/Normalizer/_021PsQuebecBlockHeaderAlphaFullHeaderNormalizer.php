...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class _021PsQuebecBlockHeaderAlphaFullHeaderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Mempool\Model\_021PsQuebecBlockHeaderAlphaFullHeader::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Mempool\Model\_021PsQuebecBlockHeaderAlphaFullHeader::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Pezos\Generated\Mempool\Model\_021PsQuebecBlockHeaderAlphaFullHeader();
        ...
        {
            return [\Pezos\Generated\Mempool\Model\_021PsQuebecBlockHeaderAlphaFullHeader::class => false];
        }
    }
} else {
    class _021PsQuebecBlockHeaderAlphaFullHeaderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
