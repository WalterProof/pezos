...
class _008PtEdo2ZkInlinedEndorsementNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Pezos\\Generated\\Mempool\\Model\\_008PtEdo2ZkInlinedEndorsement';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Pezos\\Generated\\Mempool\\Model\\_008PtEdo2ZkInlinedEndorsement';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Pezos\Generated\Mempool\Model\_008PtEdo2ZkInlinedEndorsement();
        ...
        if (\array_key_exists('operations', $data)) {
            $object->setOperations($this->denormalizer->denormalize($data['operations'], 'Pezos\\Generated\\Mempool\\Model\\_008PtEdo2ZkInlinedEndorsementContents', 'json', $context));
        }
