...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class VersionGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Rpc\Model\VersionGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Rpc\Model\VersionGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Pezos\Generated\Rpc\Model\VersionGetResponse200();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('version', $data)) {
                $object->setVersion($this->denormalizer->denormalize($data['version'], \Pezos\Generated\Rpc\Model\VersionGetResponse200Version::class, 'json', $context));
                unset($data['version']);
            }
            if (\array_key_exists('network_version', $data)) {
                $object->setNetworkVersion($this->denormalizer->denormalize($data['network_version'], \Pezos\Generated\Rpc\Model\NetworkVersion::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Rpc\Model\VersionGetResponse200::class => false];
        }
    }
} else {
    class VersionGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
