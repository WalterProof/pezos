...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NetworkPeersPeerIdPatchResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Rpc\Model\NetworkPeersPeerIdPatchResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Rpc\Model\NetworkPeersPeerIdPatchResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Pezos\Generated\Rpc\Model\NetworkPeersPeerIdPatchResponse200();
            ...
            if (\array_key_exists('conn_metadata', $data)) {
                $object->setConnMetadata($this->denormalizer->denormalize($data['conn_metadata'], \Pezos\Generated\Rpc\Model\NetworkPeersPeerIdPatchResponse200ConnMetadata::class, 'json', $context));
                unset($data['conn_metadata']);
            }
            if (\array_key_exists('peer_metadata', $data)) {
                $object->setPeerMetadata($this->denormalizer->denormalize($data['peer_metadata'], \Pezos\Generated\Rpc\Model\NetworkPeersPeerIdPatchResponse200PeerMetadata::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Rpc\Model\NetworkPeersPeerIdPatchResponse200::class => false];
        }
    }
} else {
    class NetworkPeersPeerIdPatchResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
