...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class WorkersChainValidatorsChainIdDdbGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Rpc\Model\WorkersChainValidatorsChainIdDdbGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Rpc\Model\WorkersChainValidatorsChainIdDdbGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Pezos\Generated\Rpc\Model\WorkersChainValidatorsChainIdDdbGetResponse200();
            ...
            if (\array_key_exists('operation_db', $data)) {
                $object->setOperationDb($this->denormalizer->denormalize($data['operation_db'], \Pezos\Generated\Rpc\Model\WorkersChainValidatorsChainIdDdbGetResponse200OperationDb::class, 'json', $context));
                unset($data['operation_db']);
            }
            if (\array_key_exists('operations_db', $data)) {
                $object->setOperationsDb($this->denormalizer->denormalize($data['operations_db'], \Pezos\Generated\Rpc\Model\WorkersChainValidatorsChainIdDdbGetResponse200OperationsDb::class, 'json', $context));
                unset($data['operations_db']);
            }
            if (\array_key_exists('block_header_db', $data)) {
                $object->setBlockHeaderDb($this->denormalizer->denormalize($data['block_header_db'], \Pezos\Generated\Rpc\Model\WorkersChainValidatorsChainIdDdbGetResponse200BlockHeaderDb::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Rpc\Model\WorkersChainValidatorsChainIdDdbGetResponse200::class => false];
        }
    }
} else {
    class WorkersChainValidatorsChainIdDdbGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
