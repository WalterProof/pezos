...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NetworkConnectionsPeerIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Rpc\Model\NetworkConnectionsPeerIdGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Rpc\Model\NetworkConnectionsPeerIdGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Pezos\Generated\Rpc\Model\NetworkConnectionsPeerIdGetResponse200();
            ...
            if (\array_key_exists('id_point', $data)) {
                $object->setIdPoint($this->denormalizer->denormalize($data['id_point'], \Pezos\Generated\Rpc\Model\P2pConnectionId::class, 'json', $context));
                unset($data['id_point']);
            }
            ...
            if (\array_key_exists('announced_version', $data)) {
                $object->setAnnouncedVersion($this->denormalizer->denormalize($data['announced_version'], \Pezos\Generated\Rpc\Model\NetworkVersion::class, 'json', $context));
            ...
            if (\array_key_exists('local_metadata', $data)) {
                $object->setLocalMetadata($this->denormalizer->denormalize($data['local_metadata'], \Pezos\Generated\Rpc\Model\NetworkConnectionsPeerIdGetResponse200LocalMetadata::class, 'json', $context));
                unset($data['local_metadata']);
            }
            if (\array_key_exists('remote_metadata', $data)) {
                $object->setRemoteMetadata($this->denormalizer->denormalize($data['remote_metadata'], \Pezos\Generated\Rpc\Model\NetworkConnectionsPeerIdGetResponse200RemoteMetadata::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Rpc\Model\NetworkConnectionsPeerIdGetResponse200::class => false];
        }
    }
} else {
    class NetworkConnectionsPeerIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
