...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ConfigGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Rpc\Model\ConfigGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Rpc\Model\ConfigGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Pezos\Generated\Rpc\Model\ConfigGetResponse200();
            ...
            if (\array_key_exists('rpc', $data)) {
                $object->setRpc($this->denormalizer->denormalize($data['rpc'], \Pezos\Generated\Rpc\Model\ConfigGetResponse200Rpc::class, 'json', $context));
                unset($data['rpc']);
            }
            if (\array_key_exists('p2p', $data)) {
                $object->setP2p($this->denormalizer->denormalize($data['p2p'], \Pezos\Generated\Rpc\Model\ConfigGetResponse200P2p::class, 'json', $context));
                unset($data['p2p']);
            }
            if (\array_key_exists('log', $data)) {
                $object->setLog($this->denormalizer->denormalize($data['log'], \Pezos\Generated\Rpc\Model\ConfigGetResponse200Log::class, 'json', $context));
                unset($data['log']);
            }
            ...
            if (\array_key_exists('shell', $data)) {
                $object->setShell($this->denormalizer->denormalize($data['shell'], \Pezos\Generated\Rpc\Model\ConfigGetResponse200Shell::class, 'json', $context));
                unset($data['shell']);
            }
        ...
        {
            return [\Pezos\Generated\Rpc\Model\ConfigGetResponse200::class => false];
        }
    }
} else {
    class ConfigGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
