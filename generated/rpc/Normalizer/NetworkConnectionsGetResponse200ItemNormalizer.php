...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NetworkConnectionsGetResponse200ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Pezos\Generated\Rpc\Model\NetworkConnectionsGetResponse200Item::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Pezos\Generated\Rpc\Model\NetworkConnectionsGetResponse200Item::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Pezos\Generated\Rpc\Model\NetworkConnectionsGetResponse200Item();
            ...
            if (\array_key_exists('local_metadata', $data)) {
                $object->setLocalMetadata($this->denormalizer->denormalize($data['local_metadata'], \Pezos\Generated\Rpc\Model\NetworkConnectionsGetResponse200ItemLocalMetadata::class, 'json', $context));
                unset($data['local_metadata']);
            }
            if (\array_key_exists('remote_metadata', $data)) {
                $object->setRemoteMetadata($this->denormalizer->denormalize($data['remote_metadata'], \Pezos\Generated\Rpc\Model\NetworkConnectionsGetResponse200ItemRemoteMetadata::class, 'json', $context));
        ...
        {
            return [\Pezos\Generated\Rpc\Model\NetworkConnectionsGetResponse200Item::class => false];
        }
    }
} else {
    class NetworkConnectionsGetResponse200ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
