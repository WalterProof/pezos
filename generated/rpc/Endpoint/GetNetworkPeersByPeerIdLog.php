...
class GetNetworkPeersByPeerIdLog extends \Pezos\Generated\Rpc\Runtime\Client\BaseEndpoint implements \Pezos\Generated\Rpc\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Pezos\Generated\Rpc\Model\P2pPeerPoolEvent[]|null
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Pezos\\Generated\\Rpc\\Model\\P2pPeerPoolEvent[]', 'json');
        }
